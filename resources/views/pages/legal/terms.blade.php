...
@section('description', 'Terms of Use for ICCR Tanzania website')
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="prose prose-lg max-w-none">
            ...
            <p class="text-gray-700 mb-6">
                By accessing and using the ICCR Tanzania website, you accept and agree to be bound by the terms and provision of this agreement.
            </p>
            ...
            <p class="text-gray-700 mb-6">
                In no event shall ICCR Tanzania or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on ICCR Tanzania's website.
            </p>

            <h2 class="text-2xl font-bold text-gray-900 mb-4">5. Accuracy of Materials</h2>
            <p class="text-gray-700 mb-6">
                The materials appearing on ICCR Tanzania's website could include technical, typographical, or photographic errors. ICCR Tanzania does not warrant that any of the materials on its website are accurate, complete, or current.
            </p>

            <h2 class="text-2xl font-bold text-gray-900 mb-4">6. Links</h2>
            <p class="text-gray-700 mb-6">
                ICCR Tanzania has not reviewed all of the sites linked to its website and is not responsible for the contents of any such linked site. The inclusion of any link does not imply endorsement by ICCR Tanzania of the site.
            </p>

            <h2 class="text-2xl font-bold text-gray-900 mb-4">7. Modifications</h2>
            <p class="text-gray-700 mb-6">
                ICCR Tanzania may revise these terms of service for its website at any time without notice. By using this website you are agreeing to be bound by the then current version of these terms of service.
            </p>
